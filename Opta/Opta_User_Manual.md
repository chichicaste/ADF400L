...
![Opta™ DIN rail mounting (WiFi variant)](images/user-manual-2_2.gif)
...
![Opta™ Variants](images/user-manual-23.png) 
...
![Opta™ WiFi main components](images/user-manual-1_2.png)
...
![Installing the Arduino Mbed OS Opta Boards core in the Arduino IDE](images/user-manual-3.png)
...
![Arduino PLC IDE UI](images/user-manual-25.png)
...
![Opta™ pinout (WiFi variant)](images/user-manual_4.png)
...
![Different ways to power Opta™ devices](images/user-manual_5.png)
...
![Uploading a sketch to Opta™ devices in the Arduino IDE](images/user-manual-7.png)
...
![Opta™ blink](images/user-manual-19_2.gif)
...
![The USB®-C port in Opta™ devices](images/user-manual-6.png)
...
![Power supply terminals in Opta™ devices](images/user-manual_8.png)
...
![Programmable input terminals in Opta™ devices](images/programmable-inputs.png)
...
![User-programmable LEDs in Opta™ devices](images/user-manual-10.png)
...
![Opta™ Knight Rider scanning effect](images/user-manual-21_2.gif)
...
![Opta™ blink with the green RESET LED](images/user-manual-19_2.gif)
...
![User-programmable button in Opta™ devices](images/user-manual-11.png)
...
![Opta™ user button](images/user-manual-22_2.gif)
...
![Output relays in Opta™ devices](images/user-manual-12.png)
...
![Onboard RJ45 connector in Opta™ devices](images/user-manual-13.png)
...
![Example sketch output in the Arduino IDE's Serial Monitor](images/user-manual-24_2.png)
...
![RS-485 interface in Opta™ devices](images/user-manual-15.png)
...
![Modbus interface in Opta™ devices](images/user-manual-15.png)
...
![Creating a tab in the Arduino IDE 2](images/user-manual-16.png)
...
![Example sketch output in the Arduino IDE's Serial Monitor](images/user-manual-17_2.png)
...
![Bluetooth® Low Energy service and characteristic information from an Opta™ device](images/user-manual-14.png)
...
![OPC UA GUI client with Opta](images/opta-opc-ua-gui.gif)
...
![Successful Compilation with Arduino IDE](images/arduino-ide-compilation.png)
...
![Successful Compilation with Arduino CLI](images/arduino-cli-compilation-upload.png)
...
![Server information with discovery URL - Arduino IDE](images/opta-opc-ua-arduino-ide.gif)

With [**Putty**](https://www.putty.org/), the following serial connection shows the server information:

![Server information with discovery URL - Putty](images/opta-opc-ua-cmd.gif)
...
![OPC UA GUI client](images/opta-opc-ua-gui.gif)
...
![Example sketch output in the Arduino IDE's Serial Monitor](images/user-manual-18_2.png)
...
![IoT Cloud initial page](images/user-manual-26.png)
...
![IoT Cloud Device Setup - Ethernet Connection](images/user-manual-29-eth.png)
...
![IoT Cloud Device Setup - Wi-Fi® Connection](images/user-manual-29-alt.png)
...
![IoT Cloud Setup Device pop-up window](images/user-manual-30.png)
...
![IoT Cloud "Thing" setup](images/user-manual-31.png)
...
![IoT Cloud "Thing" - Ethernet Connection](images/user-manual-31-eth.png)
...
![IoT Cloud "Thing" - Ethernet Connection](images/user-manual-31-eth-alt.png)
...
![IoT Cloud "Thing" - Wi-Fi® Connection](images/user-manual-31-alt.png)

The project is ready to add variables to your "Thing"; navigate into **Cloud Variables** and click the **ADD** button.

![Add variable button](images/user-manual-32.png)
...
![IoT Cloud "Thing" variable setup](images/user-manual-33.png)
...
![IoT Cloud Dashboards page](images/user-manual-34.png)
...
![IoT Cloud Dashboard setup](images/user-manual-35.png)
...
![Uploading a sketch to the Opta™ in the Arduino IoT Cloud](images/user-manual-36.png)
...
![Snapping Opta expansions](images/snapping.gif)
...
![Opta expansions library installation](images/library-install.png)

Install all the **library dependencies** suggested by clicking the **Install All** button:

![Library dependencies installation](images/library-install-2.png)
...
![Powering the Opta Expansions](images/power-expansion.png)
...
![Firmware update example](images/fw-update.png)
...
![Opening Serial Monitor for firmware update](images/fw-update-serial.png)
...
![Multiple expansions firmware version listing](images/fw-update-serial-5.png)
...
![Multiple firmware update process](images/fw-update-process-multi.gif)
...
![Opta Expansion variants](images/variants.png)
...
![Powering the Opta Digital Expansions](images/power-expansion.png)
...
![Opta Digital Expansions Inputs](images/16-inputs-new.png)
...
![Digital Input wiring example](images/limit-switch.gif)
...
![Analog Input wiring example](images/analog-inputs.png)
...
![Opta Digital Expansions outputs](images/variants-emr-ssr-new.png)
...
![Opta Digital Expansion outputs control demo](images/outputs-animation.gif)

Here is an example of how to connect an AC load to the Opta Digital Ext D1608E (EMR):

![EMR expansion wiring example](images/emr-output.png)

Here is an example of how to connect a DC load to the Opta Digital Ext D1608S (SSR):

![SSR expansion wiring example](images/ssr-output.png)
...
![Opta Analog Expansion](images/variant-analog.png)
...
![Powering the Opta Analog Expansions](images/power-expansion-2.png)
...
![Opta Analog Expansions Inputs](images/inputs-analog.png)
...
![Digital Input wiring example](images/digital-animation.gif)
...
![Analog voltage input wiring example](images/volt-in-a.png)
...
![Analog current input wiring example (externally powered)](images/analog-4-20-inputs.png)
...
![Analog current input wiring example (internally powered)](images/analog-4-20-in-out.png)
...
![2 Wires RTD connection example](images/rtd-2wires-user.png)
...
![3 Wires RTD connection example](images/rtd-3wires-user.png)
...
![Opta Analog Expansions Outputs](images/outputs-analog.png)
...
![Analog Voltage Output Demo](images/analog-voltage.png)
...
![Analog Current Output Demo](images/analog-current.png)
...
![Example of wiring to use the PWM outputs using Opta power voltage as **V<sub>PWM</sub>** as voltage reference](images/pwm-setup.png)
...
![PWM Output Demo](images/pwm-out.png)
...
![Analog Expansion LEDs](images/leds-analog.png)
...
![Status LED Example Animation](images/led-ani.gif)
